export default function About() {
  return (
    <section id="about" className="about">
      <h2>About Me</h2>
      <p>
        Career-changer and full-stack web development trainee at Hack Your
        Future, with over 11 years of experience in technical support, customer
        satisfaction, and team collaboration. Currently gaining hands-on
